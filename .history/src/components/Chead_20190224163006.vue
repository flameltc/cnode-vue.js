<template>
  <div class="head">
    <div class="headBox" :class="{ 'isfixed': fixed }">
      <header class="headLogo clearfix">
    ...
    <menu-slide :show="leftNavStatus" @hideMenuSli  de="hideMuneSlide"></menu-slide>
  </div>
</template>
...
export default {
  ...
  computed: mapState({
    leftNavStatus: status => state.com.leftNavStatus
  }),
  methods: {
    ...mapActions({ setNavState: 'setNavStatus' }),
