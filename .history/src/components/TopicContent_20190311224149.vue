    ...
    <div class="contentBlock">
      ...
      <div class="infoWrapper content">
        ...
        <div class="operation">
          ...
          <i class="iconfont" :class="{'icon-collection-active': topicContent.is_collect, 'icon-collection': !topicContent.is_collection}" @click="handleCollect"></i>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleCollect() {
      ...
      this.$axios.post(`https://cnodejs.org/api/v1/topic_collect/`)
    }
  }
}
</script>
