<template>
  <div class="topic-content" ref="topicContent" @scroll="showGoTop($event)">
    <div class="content-block">
      ...
      <div class="info-wrapper content">
        ...
        <div class="operation">
          ...
          <i class="iconfont" :class="{'icon-collect-active': topicContent.is_collect, 'icon-collection': !topicContent.is_collect}" @click="toggleCollect"></i>
        </div>
      </div>
    ...
    <div class="go-top" v-if="isShowGoTop" @click="goTop()">
      <img src="/src/assets/gotop.png">
    </div>
  </div>
</template>
